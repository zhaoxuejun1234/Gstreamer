...
int main(int argc, char *argv[]) {
  ...
  /*gst_element_request_pad_simple is new API and is currently only available in git master 
(to be in the 1.20 release).  1.20 is not currently available in any released version of GStreamer
 in stable linux distributions.
*/
